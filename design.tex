...
% Formatting URL using vocab.lappsgrid.org
\newcommand{\vocab}[1]{\url{http://vocab.lappsgrid.org/#1}}
% Formatting URL using ns.lappsgrid.org
\newcommand{\ns}[1]{\url{http://ns.lappsgrid.org/1.0/#1}}
% Formatting URL using ns.lappsgrid.org with a fragment identifier
\newcommand{\nsf}[2]{\url{http://ns.lappsgrid.org/1.0/#1###2}}
...
\title{The Language Application Grid API}
...
This paper describes the basic architecture and design of the \lapps Grid Application Programming Interface (API). The \lapps Grid uses the Service Grid\footnote{\url{http://servicegrid.net}} software for user authentication, authorization, service registration and service invocation. As such the \lapps API simply defines interfaces that web services \may implement to be considered \lapps compliant.
